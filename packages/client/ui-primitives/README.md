...
| `icons/*`, `FishLogo`, `BrandWordmark`, `PortalMark`, `PortalWordmark`, `HarnessNameplate`, `ReferenceIcon`, `LinkIcon` | Glyphs and brand marks. Use `LinkIcon` for 14px clickable-link categories and known-site marks. |
