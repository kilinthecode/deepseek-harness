...
- **Create a teammate** — `spawn_teammate` takes a name, a description, and the initial task, plus an optional `images` list of conversation image attachment ids appended to the prompt; only the Lead can call it.
