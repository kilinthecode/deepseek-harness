...
export const en = {
  ...
  startupFailed: 'Portal is unavailable',
  ...
  updateDownloadedTitle: 'Portal v{version} downloaded',
...
export const zh = {
  ...
  updateDownload: '下载更新',
  updateDownloadedTitle: 'Portal v{version} 下载完成',
