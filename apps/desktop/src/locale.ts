...
export const en = {
  ...
  aboutMenu: 'About Portal Harness',
  aboutProduct: 'Portal Harness',
  aboutVersion: 'Version V{version}',
  hideApplication: 'Hide Portal Harness',
  hideOtherApplications: 'Hide Others',
  showAllApplications: 'Show All',
  quitApplication: 'Quit Portal Harness',
  openApplication: 'Open Portal Harness',
  quit: 'Quit',
  cancel: 'Cancel',
  quitTitle: 'Quit Portal Harness?',
  ...
  startupFailed: 'Portal Harness is unavailable',
  ...
  welcomeTitle: 'Portal Harness',
  welcomeBrand: 'Portal Harness',
  welcomeTaglineBefore: 'Welcome to ',
  welcomeTaglineBrand: 'Portal Harness',
  welcomeTaglineAfter: '',
  ...
  updateDownloadedTitle: 'Portal Harness v{version} downloaded',
  ...
  updateTitle: 'Portal Harness Update',
  updateAvailable: 'An update is available',
  updateDetail: 'Portal Harness {version}\n\nPortal Harness will restart to complete the update.',
...
export const zh = {
  ...
  fileMenu: '文件',
  closePage: '关闭页面或窗口',
  aboutMenu: '关于 Portal Harness',
  aboutProduct: 'Portal Harness',
  aboutVersion: '版本 V{version}',
  hideApplication: '隐藏 Portal Harness',
  hideOtherApplications: '隐藏其他',
  showAllApplications: '显示全部',
  quitApplication: '退出 Portal Harness',
  openApplication: '打开 Portal Harness',
  quit: '退出',
  cancel: '取消',
  quitTitle: '退出 Portal Harness？',
  ...
  paste: '粘贴',
  selectAll: '全选',
  startupFailed: 'Portal Harness 无法使用',
  ...
  updateDownload: '下载更新',
  updateDownloadedTitle: 'Portal Harness v{version} 下载完成',
  ...
  updateTitle: 'Portal Harness 更新',
  updateAvailable: '发现可用更新',
  updateDetail: 'Portal Harness {version}\n\nPortal Harness 将重启以完成更新。',
