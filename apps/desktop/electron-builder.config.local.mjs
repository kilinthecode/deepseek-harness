 ...
 * signatures that `signIgnore` keeps. Invoke it from `apps/desktop`:
...
import { DESKTOP_BUILD_VERSION_ENV } from './scripts/desktop-build-version.mjs'
...
const buildVersion = process.env[DESKTOP_BUILD_VERSION_ENV]
const release = createElectronBuilderConfig({
  ...
  ...buildVersion === undefined ? {} : { [DESKTOP_BUILD_VERSION_ENV]: buildVersion },
