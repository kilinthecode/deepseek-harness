...
| `ctx.agentTeams` | `core` | [`experimental-agent-team`](../packages/experimental/agent-team) | - | [`experimental-tool-agent-team`](../packages/experimental/tool-agent-team), [`experimental-tool-agent-room`](../packages/experimental/tool-agent-room), [`experimental-client-ui-agent-team`](../packages/experimental/client-ui-agent-team) | - | Owns the implicit-root roster, durable peer mailbox, shared task DAG, shared room, continuable-child lifecycle, and generated room Remote methods; tool-agent-team and tool-agent-room contribute model controls and client-ui-agent-team mounts the room Remote contribution. |
