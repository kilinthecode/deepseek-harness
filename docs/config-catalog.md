...
Requires: `agents` · `sessions` · `sessionPersistence` · `sessionProjections` · `subagents` · `llm`
...
Source: [`packages/experimental/agent-team/src/types.ts:406`](../packages/experimental/agent-team/src/types.ts)
