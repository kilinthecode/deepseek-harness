...
|---|---|---|
| `id` | required | `string` |
| `phase` | required | [`RoomProposalPhase`](#persistence-type-sha256-ad55dec6cb271a58545ecc7276a678e644c8d477d34b10e7c110d7bec7be10d4) |
...
| `verdict` | required | [`RoomReviewVerdict`](#persistence-type-sha256-ebbe45588a7e427520730786bc8ca81e431296de013fc20264e90a048641b4a6) |
...
| Property | Presence | Type |
|---|---|---|
| `kind` | required | [`RoomReviewTimeoutKind`](#persistence-type-sha256-31c9881330a05908cd0ce415fa5e1cea55ccc1ab56d15246da94d6f842ccef20) |
| `proposalId` | required | `string` |
| `proposalRevision` | required | `number` |
| `stalled` | required | [`string[]`](#persistence-type-sha256-93c33d9687613293f8c95d46c4d922fe9ceae83b84c384beff5c3315abe005f2) |
...
| `verification` | optional | [`TeamTaskVerification`](#persistence-type-sha256-2434ef323d8a403db8faef23c251d00e30ff3b10d748e7d4f975e5fa86cd5775) |
...
| `verdict` | optional | [`union (2 variants)`](#persistence-type-sha256-a14e8974738b2270bf2fc6ffe720514f7a74e4bf2af72bda44f4849cf479c73a) |
...
Sources: [`packages/api/session-controller/src/types.ts:396`](../packages/api/session-controller/src/types.ts) · [`packages/attachment/attachment/src/brand.ts:6`](../packages/attachment/attachment/src/brand.ts) · [`packages/compaction/compaction/src/brand.ts:4`](../packages/compaction/compaction/src/brand.ts) · [`packages/core/session/src/types.ts:20`](../packages/core/session/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:192`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:20`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:204`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:32`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:8`](../packages/experimental/agent-team/src/types.ts) · [`packages/feedback/message-feedback/src/types.ts:14`](../packages/feedback/message-feedback/src/types.ts) · [`packages/goal/goal/src/types.ts:17`](../packages/goal/goal/src/types.ts) · [`packages/interaction/commands/src/brand.ts:31`](../packages/interaction/commands/src/brand.ts) · [`packages/interaction/user-approval/src/types.ts:17`](../packages/interaction/user-approval/src/types.ts) · [`packages/llm/llm-retry/src/brand.ts:4`](../packages/llm/llm-retry/src/brand.ts) · [`packages/llm/llm/src/brand.ts:16`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:31`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:43`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:67`](../packages/llm/llm/src/brand.ts) · [`packages/schedule/schedule/src/types.ts:12`](../packages/schedule/schedule/src/types.ts) · [`packages/session/session-title/src/index.ts:42`](../packages/session/session-title/src/index.ts) · [`packages/session/session-title/src/types.ts:17`](../packages/session/session-title/src/types.ts) · [`packages/webhook/webhook/src/brand.ts:12`](../packages/webhook/webhook/src/brand.ts) · [`packages/webhook/webhook/src/brand.ts:6`](../packages/webhook/webhook/src/brand.ts) · [`packages/webhook/webhook/src/brand.ts:9`](../packages/webhook/webhook/src/brand.ts) · [`packages/workflow/workflow/src/types.ts:13`](../packages/workflow/workflow/src/types.ts)
...
| Property | Presence | Type |
|---|---|---|
| `message` | required | [`RoomMessageSnapshot`](#persistence-type-sha256-8a4282d56febc4ae789c1aa1bffbf2ec819db67f513c0d10c1362877ab24ad74) |
| `teamId` | required | `string` |
| `version` | required | `1` |
...
| Property | Presence | Type |
|---|---|---|
| `proposal` | required | [`RoomProposalSnapshot`](#persistence-type-sha256-865310c12876e6d4b1d1e18654af876c6322ec78b6d956d5b79b9c0775d8a814) |
| `teamId` | required | `string` |
| `version` | required | `1` |
...
| Property | Presence | Type |
|---|---|---|
| `review` | required | [`RoomReviewSnapshot`](#persistence-type-sha256-3532520fc3e81de2130e774db321a4ce7f29450f9afdde0af34f65852d5abc9b) |
| `teamId` | required | `string` |
| `version` | required | `1` |
...
| Property | Presence | Type |
|---|---|---|
| `task` | required | [`TeamTaskSnapshot`](#persistence-type-sha256-74ba15aa5b9e627d0c54bcaf3b7e25699babba511019ec43ad2982141365627f) |
| `teamId` | required | `string` |
| `version` | required | `2` |
...
|---|---|---|
| `teamId` | required | `string` |
| `timeout` | required | [`RoomReviewTimeoutSnapshot`](#persistence-type-sha256-e6032d5096510086a3b1f0926e238edb4cff6eed7f3b2b23afaa35b7d64c5bf6) |
| `version` | required | `1` |
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`{ message, teamId, version }`](#persistence-type-sha256-1d5867e68958ee6f084db97e89298c94243dedcc4d18e9f091a4da178d1772a8) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`{ proposal, teamId, version }`](#persistence-type-sha256-bb6ebb275973875ca63e5b0ed34fb255fc66ddedf4ad48b7d5c660ac61f6990c) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`{ review, teamId, version }`](#persistence-type-sha256-cc5d455c46ce83bd37aab4d0b04defbf7f72f93f56f614ffb330e0008dc98f98) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`{ teamId, timeout, version }`](#persistence-type-sha256-a7cb04a9435451ebb0502dbe56f60a6b8c4e429f5889eb33de50eb07874e9ba4) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`{ task, teamId, version }`](#persistence-type-sha256-3ad42a09b23327a08b08ccd7f2b835488a2852ffce94d9f8e865468b5ba7890b) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
