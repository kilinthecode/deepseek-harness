...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  RoomMessageId: 'agent-team.md',
  RoomProposalId: 'agent-team.md',
  RoomProposalPhase: 'agent-team.md',
  RoomReviewVerdict: 'agent-team.md',
  RoomMessageSnapshot: 'agent-team.md',
  RoomProposalSnapshot: 'agent-team.md',
  RoomReviewSnapshot: 'agent-team.md',
  RoomParticipantView: 'agent-team.md',
  RoomMessageView: 'agent-team.md',
  RoomProposalView: 'agent-team.md',
  RoomView: 'agent-team.md',
  RoomPromptRequest: 'agent-team.md',
  RoomPromptResult: 'agent-team.md',
  ProposeRoomDecisionRequest: 'agent-team.md',
  ReviewRoomDecisionRequest: 'agent-team.md',
  EscalateRoomDecisionRequest: 'agent-team.md',
  RoomRemoteView: 'agent-team.md',
  RoomFollowFrame: 'agent-team.md',
  PanelRoomPromptRequest: 'agent-team.md',
  PanelProposeRoomDecisionRequest: 'agent-team.md',
  PanelEscalateRoomDecisionRequest: 'agent-team.md',
  RoomStreamFrame: 'agent-team.md',
  RoomTranscriptEntry: 'agent-team.md',
  RoomConfig: 'agent-team.md',
