...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/portal-brand': { kind: 'none', reason: 'The fork brand occupants render sidebar and hero presentation only; no copy or artwork reaches a model request.' },
